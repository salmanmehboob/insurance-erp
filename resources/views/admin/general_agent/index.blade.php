...
@section('content')
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                ...
                <div class="header-elements">
                        <div class="col-md-12 mt-5">
                            @can('create-general-agent')
                            <a href="{{ route('add-general-agent') }}" class="btn btn-outline-primary float-end">
                                <b><i class="fas fa-plus"></i></b> {{ $title }}
                            </a>
                            @endcan

                                <a href="{{ route('general-agent.trashed') }}" class="btn btn-outline-danger float-end me-4">
                                    <b><i class="fas fa-trash-alt"></i></b> View Deleted General Agent
                                </a>
            ...
            <div class="card-body">
                <table id="insurance-general-agent-table" class="table table-striped datatables-reponsive">
                    <thead>
                    <tr>
                        <th>Name</th>
                        <th>Phone</th>
                    ...
                    <tbody>
                    @foreach($generalAgents as $company)
                        <tr>
                            ...
                            <td>
                                <div class="d-flex action-buttons">
                                    @can('edit-general-agent')
                                        <a title="Edit" href="{{ route('edit-general-agent', $company->id) }}"
                                           class="text-primary me-2 action-buttons">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                    @endcan

                                    @can('delete-general-agent')
                                        <a href="javascript:void(0)"
                                           data-url="{{ route('destroy-general-agent') }}"
                                           data-status="0"
                                           data-label="delete"
                                           data-id="{{ $company->id }}"
