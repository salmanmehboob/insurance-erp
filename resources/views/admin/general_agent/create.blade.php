...
@section('content')
    ...
    <div class="content">
        ...
        <div class="card">
            <!-- Company form -->
            <form action="{{ route('store-general-agent') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <fieldset class="border p-3 mb-4">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                                <input type="text" name="website" class="form-control required-field"
                        ...
                        <div class="tab-pane fade" id="notes-tab">
                            <div class="row mt-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <textarea name="note" class="form-control required-field" rows="5"
