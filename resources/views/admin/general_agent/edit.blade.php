...
@section('content')
    ...
    <div class="content">
        ...
        <div class="card">
            <!-- Company form -->
            <form action="{{ route('update-general-agent', $company->id) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="tab-pane fade" id="notes-tab">
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <textarea name="note" class="form-control required-field" rows="4">{{ old('notes', $company->note) }}</textarea>
                                        @if ($errors->has('note'))
