...
@section('content')
    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><span class="font-weight-semibold">New Policy Report</span></h4>
            </div>
        </div>
    </div>
    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card bg-primary">
                    <div class="card-body">
                        <h6 class="card-title text-white">Total New Policies</h6>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="GET" action="{{ route('transaction-report.new-policy') }}" id="filterForm">
                    <div class="row">
                        <div class="col-md-6">
        ...
        <!-- New Policy Report Table -->
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">New Policy Report</h5>
            </div>
            <div class="card-body">
                <table class="table table-striped datatables-reponsive">
                    ...
                    @foreach($clients as $client)
                        ...
                        <tr>
                            <td>
                                @php
                                    // Adjust to your policy date column (e.g., $client->policy_date or $client->effective_date)
                                    $date = $client->policy_date ?? $client->created_at;
                                @endphp
                                {{ $date ? date('M d, Y', strtotime($date)) : 'N/A' }}
                            </td>
