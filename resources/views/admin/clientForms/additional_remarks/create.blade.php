                ...
                <div class="header-top">
                    ...
                    <div class="header-right-meta">
                        <div class="form-field-line">
                            ...
                            <input type="text" value="" class="w-[100%]" name="agency_customer_id" placeholder="AGENCY CUSTOMER ID">
                        </div>
                        <div class="form-field-line loc-field">
                            <label>LOC #:</label>
                            <input type="text" value="" class="w-[100%]" name="loc" placeholder="LOC #">
                        </div>
                ...
                <div class="" style="position: relative;">
                    <table class="table-ars">
                        <tr>
                            <td>
                                <label>AGENCY</label>
                                <p><input type="text" value="" class="w-[100%]" name="agency_name" placeholder="AGENCY NAME"></p>
                            </td>
                            <td rowspan="2" style="place-content: flex-start;">
                                <label>NAMED INSURED</label>
                                <p><input type="text" value="" class="w-[100%]" name="name_insured" placeholder="NAMED INSURED"></p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <label>POLICY NUMBER</label>
                                <p><input type="text" value="" class="w-[100%]" name="policy_number" placeholder="POLICY NUMBER"></p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <label>CARRIER</label>
                                <p><input type="text" value="" class="w-[100%]" name="carrier" placeholder="CARRIER"></p>
                            </td>
                            <td>
                                 <label>NAIC CODE</label>
                                <p><input type="text" value="" class="w-[100%]" name="naic_code" placeholder="NAIC CODE"></p>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                 <label>EFFECTIVE DATE  (MM/DD/YYYY)</label>
                                <p><input type="text" value="" class="w-[100%]" name="effective_date" placeholder="Effective Dates"></p>
                            </td>
                        </tr>
                    </table>
                        ...
                        <td>
                            <div class="remarks-header-line">
                                <div class="form-field-line">
                                    ...
                                    <input type="text" value="" name="form_no" placeholder="Form #">
                                </div>
                                <div class="form-field-line">
                                    <label>FORM TITLE:</label>
                                    <input type="text" value="" name="form_title" placeholder="Title">
                                </div>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="remarks-container">
                                ...
                                <textarea class="remarks-textarea-field" name="description" placeholder="Enter Additional Remarks Here..."></textarea>
                            </div>
                        </td>
                    </tr>
                </table>
