...
@section('content')
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                ...
                <div class="header-elements">
                        <div class="col-md-12 mt-5">
                            @can('create-financial-company')
                            <a href="{{ route('add-financial-company') }}" class="btn btn-outline-primary float-end">
                                <b><i class="fas fa-plus"></i></b> {{ $title }}
                            </a>
                            @endcan

                                <a href="{{ route('financial-company.trashed') }}" class="btn btn-outline-danger float-end me-4">
            ...
            <div class="card-body">
                <table id="financial-company-table" class="table table-striped datatables-reponsive">
                    <thead>
                    <tr>
                        <th>Name</th>
                        <th>Phone</th>
                    ...
                    <tbody>
                    @foreach($financialCompanies as $company)
                        <tr>
                            ...
                            <td>{{ $company->agency_code }}</td>
                             <td>
                                <div class="d-flex action-buttons">
                                    ...
                                    @can('delete-financial-company')
                                        <a href="javascript:void(0)"
                                           data-url="{{ route('destroy-financial-company') }}"
                                           data-status="0"
                                           data-label="delete"
                                           data-id="{{ $company->id }}"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="companyModalLabel">Financial Company Details</h5>
