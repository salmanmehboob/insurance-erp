            ...
            <div class="card-header header-elements-inline">
                ...
                <div class="header-elements">
                         <div class="col-md-12 mt-5">
                             <a href="{{ route('show-financial-company') }}" class="btn btn-outline-success float-end me-4">
                ...
                <table id="insurance-company-table" class="table table-striped datatables-reponsive">
                    ...
                    @foreach($trashedCompanies as $company)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('financial-company.restore', $company->id) }}" class="btn btn-success btn-sm">
                                    Restore
                                </a>
                                <form action="{{ route('financial-company.forceDelete', $company->id) }}" method="POST" style="display: inline-block;">
                                    @csrf
                                    @method('DELETE')
