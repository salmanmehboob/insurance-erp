                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                            ...
                            <a class="nav-link active" id="v-pills-summary-tab-{{ $policy->id }}"
                                data-bs-toggle="pill" href="#v-pills-summary-{{ $policy->id }}" role="tab"
                                aria-controls="v-pills-summary-{{ $policy->id }}" aria-selected="true">Summary</a>

                            <a class="nav-link" href="{{ route('edit-client', $policy->client->id) }}"
                                target="_blank">Edit
                                Details</a>
                    ...
                    <div class="col-md-9">
                        <div class="tab-content" id="v-pills-tabContent-{{ $policy->id }}">
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h3 class="mb-3">
                                                <strong>Name:</strong>
                                                {{ optional($policy->client)->applicant_name ?? 'N/A' }}
                                            </h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <p><strong>Home
                                                    Phone:</strong>
                                                {{ optional($policy->client)->home_phone_no ?? 'N/A' }}
                                            </p>
                                        </div>
                                        <div class="col-md-4">
                                            <p><strong>Work
                                                    Phone:</strong>
                                                {{ optional($policy->client)->work_phone_no ?? 'N/A' }}
                                            </p>
                                        </div>
                                        <div class="col-md-4">
                                            <p><strong>Cell
                                                    Phone:</strong>
                                                {{ optional($policy->client)->cell_phone_no ?? 'N/A' }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p><strong>Policy
                                                    Status:</strong>
                                                {{ optional($policy->policyStatus)->name ?? 'N/A' }}
                                            </p>
                                        </div>
                                        <div class="col-md-6">
                                            <p>
                                                <strong>Company:</strong>
                                                {{ optional($policy->insuranceCompany)->name ?? 'No Company Selected' }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p><strong>Agent:</strong> {{ optional($policy->agent)->name ?? 'N/A' }}
                                            </p>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p><strong>Policy
                                                    Type:</strong>
                                                {{ optional($policy->client->policyType)->name ?? 'N/A' }}
                                            </p>
                                        </div>
                                        <div class="col-md-6">
                                            <p>
                                                <strong>Coverage:</strong>
                                                {{ optional($policy->coverage)->name ?? 'Property' }}
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <!-- Notes Tab -->
                            <div class="tab-pane fade text-black" id="v-pills-notes-{{ $policy->id }}"
                                role="tabpanel" aria-labelledby="v-pills-notes-tab-{{ $policy->id }}">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-10">
                            ...
                            <!-- Forms & Letter Tab -->
                            <div class="tab-pane fade text-black" id="v-pills-forms-{{ $policy->id }}"
                                role="tabpanel" aria-labelledby="v-pills-forms-tab-{{ $policy->id }}">
                                <div class="container py-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <a target="_blank"
                                                href="{{ route('view.form', ['type' => 'agent_broker']) }}"
                                        ...
                                        <div class="col-md-4">
                                            <a target="_blank"
                                                href="{{ route('view.form', ['type' => 'additional_remarks']) }}"
                                                class="btn btn-info w-100 mb-2">View Forms</a>
                                        ...
                                        <div class="col-md-4">
                                            <a target="_blank"
                                                href="{{ route('view.form', ['type' => 'evidenceOfProperty']) }}"
                                                class="btn btn-info w-100 mb-2">View Forms</a>
                                        ...
                                        <div class="col-md-4">
                                            <a target="_blank"
                                                href="{{ route('view.form', ['type' => 'invoiceForPayment']) }}"
                                                class="btn btn-info w-100 mb-2">View Forms</a>
                                        ...
                                        <div class="col-md-4">
                                            <a target="_blank"
                                                href="{{ route('view.form', ['type' => 'propertyLoss']) }}"
                                                class="btn btn-info w-100 mb-2">View Forms</a>
                                        ...
                                        <div class="col-md-4">
                                            <a target="_blank"
                                                href="{{ route('view.form', ['type' => 'propertyInsurance']) }}"
                                                class="btn btn-info w-100 mb-2">View Forms</a>
                                        ...
                                        <div class="col-md-4">
                                            <a target="_blank"
                                                href="{{ route('view.form', ['type' => 'InsuranceCard']) }}"
                                                class="btn btn-info w-100 mb-2">View Forms</a>
                                        ...
                                        <div class="col-md-4">
                                            <a target="_blank"
                                                href="{{ route('view.form', ['type' => 'GeneralLiability']) }}"
                                                class="btn btn-info w-100 mb-2">View Forms</a>
                                        ...
                                        <div class="col-md-8">
                                            <a href="{{ route('create-dwelling-application-form', $policy->client->id) }}" class="text-primary w-100">DWELLING FIRE APPLICATION</a>
                                        ...
                                        <div class="col-md-4">
                                            <a target="_blank" href="{{route('view.form',['type' => 'DwellingFireApplication'])}}" class="btn btn-info w-100 mb-2">View Forms</a>
                                            {{-- <a target="_blank"
                                                href="{{ route('view-uploaded-form', ['type' => 'dwelling_fire', 'client_id' => $policy->client->id]) }}"
                                                class="btn btn-info btn-sm w-100 mb-2 text-uppercase">
                                                <i class="fa fa-eye"></i> View
                                            </a> --}}
                                        </div>
                                        ...
                                        <div class="col-md-8">
                                            <a href="{{ route('create-property-section-form', $policy->client->id) }}"
                                                class="text-primary w-100">PROPERTY SECTION</a>
                                        ...
                                        <div class="col-md-4">
                                            <a target="_blank"
                                                href="{{ route('view.form', ['type' => 'PropertySection']) }}"
                                                class="btn btn-info w-100 mb-2">View Forms</a>
                                            {{-- <a target="_blank"
                                                href="{{ route('view-uploaded-form', ['type' => 'property_section', 'client_id' => $policy->client->id]) }}"
                                                class="btn btn-info btn-sm w-100 mb-2 text-uppercase">
                                                <i class="fa fa-eye"></i> View
                                            </a> --}}
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a target="_blank"
                                                href="{{ route('view-uploaded-form', ['type' => 'umbrella_section', 'client_id' => $policy->client->id]) }}"
                                                class="btn btn-info btn-sm w-100 mb-2 text-uppercase">
                                                <i class="fa fa-eye"></i> View
                                            </a>
                                        </div>
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <a href="{{ route('show-upload-form', ['type' => 'worker_compensation', 'client_id' => $policy->client->id]) }}"
                                                class="text-primary w-100 text-uppercase">WORKERS COMPENSATION
                                                APPLICATION</a>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            {{--                                            <a target="_blank" href="{{route('view.form',['type' => 'InsuranceApplication'])}}" class="btn btn-info w-100 mb-2">View Forms</a> --}}
                                            <a target="_blank"
                                                href="{{ route('view-uploaded-form', ['type' => 'worker_compensation', 'client_id' => $policy->client->id]) }}"
                                                class="btn btn-info btn-sm w-100 mb-2 text-uppercase">
                                                <i class="fa fa-eye"></i> View
                                            </a>
                                        </div>
                            ...
                            <div class="tab-pane fade text-black" id="v-pills-attachment-{{ $policy->id }}"
                                role="tabpanel" aria-labelledby="v-pills-attachment-tab-{{ $policy->id }}">
                                <div class="container py-3">
                                    <div class="row">
                                        <div class="col-12">
                                            <h2>Attachment</h2>
                                        ...
                                        <template id="attachment-template">
                                            <div class="attachment-row mt-5">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <button type="button"
                                                            class="btn btn-danger mt-3 remove-row"><i
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#v-pills-Policy-Accounting-tab').on('click', function() {
                ...
                $('#v-pills-Policy-Accounting').html(
                    '<h2>Policy-Accounting</h2><p>Here is some content for Policy-Accounting...</p>');
            });
        });
    </script>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#upload-attachments').click(function() {
                ...
                if (!hasFile) {
                    $('#upload-status').html(
                        '<span class="text-danger">Please add at least one valid attachment.</span>');
                    return;
                }
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        $('#upload-status').html(
                            '<span class="text-info">Uploading attachments...</span>');
                    },
                    success: function(response) {
                        if (response.success) {
                            $('#upload-status').html('<span class="text-success">' + response
                                .message + '</span>');
                    ...
                    error: function(xhr) {
                        ...
                        $('#upload-status').html('<span class="text-danger">' + message +
                            '</span>');
                    }
                });
            });
