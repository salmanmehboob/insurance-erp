                                    ...
                                    <select name="email_status_id" class="form-control select2 "
                                        ...
                                        @foreach($emailStatues as $state)
                                            <option value="{{ $state->id }}"
                                                {{ old('email_status_id') == $state->id ? 'selected' : ($state->id == 2 && !old('email_status_id') ? 'selected' : '') }}>
                                                {{ $state->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <select name="construction"
                                                            ...
                                                            <option value="solid_brick">Solid Brick</option>
                        ...
                        <fieldset class="border p-3 mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <select name="body_injury" class="form-control select2 "
                                                style="width: 100%"
                                                data-placeholder="Select Option">
                                            <span class="error-message text-danger"></span>
                                            <option value="">Select Option</option>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <select name="pip" class="form-control select2 "
                                                style="width: 100%"
                                                data-placeholder="Select Option">
                                            <span class="error-message text-danger"></span>
                                            <option value="">Select Option</option>
                    ...
                    <div class="tab-pane fade" id="notes-tab">
                        <fieldset class="border p-3 mb-4">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="col-md-12">
                                        <label class="col-form-label">Memo / Notes
                                        </label>
                                        <div class="form-group">
