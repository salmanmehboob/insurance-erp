            ...
            <div class="card-header header-elements-inline">
                ...
                <div class="header-elements">
                        <div class="col-md-12 mt-5">
                            ...
                            <a href="{{ route('add-commission') }}" class="btn btn-outline-primary float-end">
                            ...
                            <td>{{ $commission->notes }}</td>
                             <td>
                                <div class="d-flex action-buttons">
                                    @can('edit-commission')
                                        <a title="Edit" href="{{ route('edit-commission', $commission->id) }}"
                                    ...
                                    @can('delete-commission')
                                        <a href="javascript:void(0)"
                                           data-url="{{ route('destroy-commission') }}"
                                           data-status="0"
                                           data-label="delete"
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label for="commission_name" class="form-label">Commission</label>
                                    <input type="text" class="form-control" id="commission_name" disabled>
                                </div>
...
@push('script')
    ...
    <script>
        $(document).ready(function () {
            ...
            // Populate modal with commission details on row click
            $(".clickable-row").on("click", function () {
                ...
                var commission_name = $(this).data("commission_name");
                ...
                $('#address').val(address);
                $('#commission_name').val(commission_name);
