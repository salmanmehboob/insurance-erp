...
@section('content')
    ...
    <div class="content">
        <!-- Form -->
        <div class="card">
            <form action="{{ route('update-reminder', $reminder->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="card-body">
                    <div class="row mt-3">
                            ...
                            <div class="form-group">
                                <select name="client_id" id="client_id" class="form-control select2"
                                    ...
                                    @foreach($clients as $row)
                                        <option
                                            value="{{ $row->id }}" {{ $reminder->client_id == $row->id ? 'selected' : '' }}>{{ $row->applicant_name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                <select name="to_id" id="to_id" class="form-control select2"
                                    ...
                                    @foreach($agents as $row)
                                        <option
                                            value="{{ $row->id }}" {{ $reminder->to_id ==  $row->id  ? 'selected' : '' }}>
                                            {{ $row->name }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('to_id'))
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <select name="set_reminder" id="set_reminder" class="form-control select2"
                                    ...
                                    <option></option>
                                    <option {{$reminder->set_reminder == 1 ? 'selected' : ''}} value="1">YES</option>
                                    <option {{$reminder->set_reminder == 0 ? 'selected' : ''}} value="0">No</option>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <input type="checkbox"  {{$reminder->is_critical == 1 ? 'checked' : ''}} name="is_critical" class="form-check-inline"
                            ...
                            <div class="form-group">
                                <select name="insurance_company_id" id="insurance_company_id" class="form-control select2"
                                    ...
                                    @foreach($insuranceCompanies as $row)
                                        <option
                                            value="{{ $row->id }}" {{ $reminder->insurance_company_id ==  $row->id  ? 'selected' : '' }}>
                                            {{ $row->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" rows="10" name="notes">{{$reminder->notes}}</textarea>
                                @if ($errors->has('notes'))
                                    <span
