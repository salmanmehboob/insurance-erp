            ...
            <div class="card-header header-elements-inline">
                ...
                <div class="header-elements">
                        <div class="col-md-12 mt-5">
                            @can('create-bank')
                            <a href="{{ route('add-bank') }}" class="btn btn-outline-primary float-end">
                         ...
                         <tr>
                            ...
                            <td>
                                <div class="d-flex action-buttons">
                                    @can('edit-bank')
                                        <a title="Edit" href="{{ route('edit-bank', $bank->id) }}"
...
@push('script')
    ...
    <script>
        $(document).ready(function () {
            ...
            // Populate modal with bank details on row click
